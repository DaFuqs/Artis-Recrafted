...
public class Artis implements ModInitializer {
    ...
    public static ArtisTableType registerTable(ArtisTableType type, Block.Settings settings) {
        return registerTable(type, settings, ArtisItemGroups.ARTIS_GROUP);
    }
    ...
    public void onInitialize() {
        ...
        ARTIS_BLOCK_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(MODID, "artis_table"), FabricBlockEntityTypeBuilder.create(ArtisTableBlockEntity::new, artisBlocks).build());
    }
